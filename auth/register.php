...
<form class="login100-form validate-form" name="form1" method="post" action="check_register.php">
<span class="login100-form-title p-b-49">
Teacher Registration
</span>
<div class="wrap-input100 validate-input m-b-23" data-validate="Username is required">
<span class="label-input100">Fullname</span>
<input class="input100" type="text" name="my_fullname" id="my_fullname" placeholder="Type your Fullname">
<span class="focus-input100" data-symbol="&#xf206;"></span>
</div>
</span>
<div class="wrap-input100 validate-input m-b-23" data-validate="Username is required">
<span class="label-input100">Username</span>
<input class="input100" type="text" name="myusername" id="myusername" placeholder="Type your username">
<span class="focus-input100" data-symbol="&#xf206;"></span>
</div>
<div class="wrap-input100 validate-input" data-validate="Password is required">
<span class="label-input100">Password</span>
<input class="input100" type="password" name="mypassword" id="mypassword" placeholder="Type your password">
<span class="focus-input100" data-symbol="&#xf190;"></span>
</div>
<div class="text-right p-t-8 p-b-31">
Try your best to always remember your password please
</div>
...
Already Registered? Login here then!
</span>
<a href="main-login.php" class="txt2">
Login
</a>
</div>
</form>
